...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-gray-100 dark:bg-slate-700 p-1 text-gray-600 dark:text-slate-400",
      className
    )}
    {...props}
  />
